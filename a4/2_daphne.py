...
plot_histogram_bbvi(rs[:, 0], Ws, "Histogram for slope in 2.daphne", "slope", "2_daphne_slope_histogram")
plot_histogram_bbvi(rs[:, 1], Ws, "Histogram for bias in 2.daphne", "bias", "2_daphne_bias_histogram")
