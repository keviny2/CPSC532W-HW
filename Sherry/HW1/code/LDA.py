...
bagofwords = loadmat('/Users/xiaoxuanliang/Desktop/CPSC 532W/HW/a1/data/bagofwords_nips.mat')
# words converted into integers
WS = bagofwords['WS'][0] - 1  #go to 0 indexed
# document each word comes from
DS = bagofwords['DS'][0] - 1
# word corresponding to the integer
WO = loadmat('/Users/xiaoxuanliang/Desktop/CPSC 532W/HW/a1/data/words_nips.mat')['WO'][:,0]
# title of each document
titles = loadmat('/Users/xiaoxuanliang/Desktop/CPSC 532W/HW/a1/data/titles_nips.mat')['titles'][:,0]
