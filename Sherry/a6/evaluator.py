...
def run_deterministic_tests():
    ...
    for i in range(1,15):
        ...
        exp = daphne(['desugar-hoppl-cps', '-i', '/Users/xiaoxuanliang/Desktop/CPSC 532W/HW/a6/programs/tests/deterministic/test_{}.daphne'.format(i)])
    ...
    for i in range(1,13):
        ...
        exp = daphne(['desugar-hoppl-cps', '-i', '/Users/xiaoxuanliang/Desktop/CPSC 532W/HW/a6/programs/tests/hoppl-deterministic/test_{}.daphne'.format(i)])
...
def run_probabilistic_tests():
    ...
    for i in [1,2,3,4,6]: #test 5 does not work, sorry.
        exp = daphne(['desugar-hoppl-cps', '-i', '/Users/xiaoxuanliang/Desktop/CPSC 532W/HW/a6/programs/tests/probabilistic/test_{}.daphne'.format(i)])
